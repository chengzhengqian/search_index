...
var FS433_KEY_CTRL = 18; //17 is control, 18 is alt. 
...
var FS433_initTabs = function(){
	if( !FS433_Tabs_Obj.init ){
		...
		div1.setAttribute("style","font-size: 100%")
...
window.addEventListener('keydown', function(e){
	...
	if( ( e.keyCode == FS433_KEY_CTRL ) && FS433_state && FS433_fullscreen ){
	//if( ( e.keyCode == 17 ) ){
		if( !FS433_tabstatus ){
			FS433_tabstatus = true;
			FS433_tabtimer = setTimeout(function(){ chrome.runtime.sendMessage({query: 'list'}); }, 100);
		}
	}
